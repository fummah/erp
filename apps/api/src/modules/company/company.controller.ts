...
export class CompanyController {
  ...
  @Get('meta') async meta(@Req() req: any) {
    ...
    const [branches, departments, accounts, customers, suppliers, items, warehouses, employees, taxRates, plans] = await Promise.all([
    ...
    return { branches, departments, accounts, customers, suppliers, items, warehouses, employees, taxRates, plans };
  }
}

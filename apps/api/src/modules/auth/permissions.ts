...
export const PERMISSIONS: PermissionDef[] = [
  ...
  { code: 'performance.templates.view', name: 'View KPI templates', module: 'performance' },
  { code: 'performance.templates.manage', name: 'Manage KPI templates', module: 'performance' },
  { code: 'performance.cycles.view', name: 'View performance cycles', module: 'performance' },
  { code: 'performance.cycles.manage', name: 'Manage performance cycles', module: 'performance' },
  { code: 'performance.self.view', name: 'View own performance assessments', module: 'performance' },
  { code: 'performance.self.submit', name: 'Submit self assessment', module: 'performance' },
  { code: 'performance.team.view', name: 'View team performance', module: 'performance' },
  { code: 'performance.manager.review', name: 'Review team assessments', module: 'performance' },
  { code: 'performance.qa.view', name: 'View quality assurance', module: 'performance' },
  { code: 'performance.qa.review', name: 'Perform quality assurance reviews', module: 'performance' },
  { code: 'performance.calibration.manage', name: 'Manage calibration', module: 'performance' },
  { code: 'performance.approve', name: 'Approve performance results', module: 'performance' },
  { code: 'performance.incentives.view', name: 'View performance incentives', module: 'performance' },
  { code: 'performance.incentives.propose', name: 'Propose performance incentives', module: 'performance' },
  { code: 'performance.incentives.approve', name: 'Approve performance incentives', module: 'performance' },
  { code: 'performance.reports.view', name: 'View performance reports', module: 'performance' },
  ...
  { code: 'reports.financial.view', name: 'View financial reports', module: 'reports' },
  { code: 'reports.sales.view', name: 'View sales reports', module: 'reports' },
  { code: 'reports.purchasing.view', name: 'View purchasing reports', module: 'reports' },
  { code: 'reports.inventory.view', name: 'View inventory reports', module: 'reports' },
  { code: 'reports.customers.view', name: 'View customer reports', module: 'reports' },
  { code: 'reports.hr.view', name: 'View HR reports', module: 'reports' },
  { code: 'reports.performance.view', name: 'View performance reports', module: 'reports' },
  { code: 'reports.assets.view', name: 'View asset reports', module: 'reports' },
  { code: 'reports.compliance.view', name: 'View compliance reports', module: 'reports' },
  { code: 'reports.audit.view', name: 'View audit reports', module: 'reports' },
  { code: 'reports.custom.create', name: 'Create custom reports', module: 'reports' },
  { code: 'reports.custom.share', name: 'Share custom reports', module: 'reports' },

  { code: 'admin.users.view', name: 'View users', module: 'admin' },
  { code: 'admin.users.manage', name: 'Manage users', module: 'admin' },
  { code: 'admin.users.invite', name: 'Send / resend user invitations', module: 'admin' },
  { code: 'admin.users.deactivate', name: 'Activate / deactivate users', module: 'admin' },
  { code: 'admin.sessions.revoke', name: 'Revoke user sessions', module: 'admin' },
  { code: 'admin.memberships.view', name: 'View memberships', module: 'admin' },
  { code: 'admin.memberships.manage', name: 'Manage memberships', module: 'admin' },
  { code: 'admin.branches.view', name: 'View branches', module: 'admin' },
  { code: 'admin.branches.manage', name: 'Manage branches', module: 'admin' },
  { code: 'admin.audit.view', name: 'View audit logs', module: 'admin' },
  { code: 'admin.audit.export', name: 'Export audit logs', module: 'admin' },
  { code: 'admin.config.view', name: 'View configuration', module: 'admin' },
  { code: 'admin.config.manage', name: 'Manage configuration', module: 'admin' },
  { code: 'admin.access_reviews.view', name: 'View access reviews', module: 'admin' },
  ...
  { code: 'integrations.view', name: 'View integrations', module: 'integrations' },
  { code: 'integrations.configure', name: 'Configure integrations', module: 'integrations' },
  { code: 'integrations.health.run', name: 'Run integration health checks', module: 'integrations' },
  { code: 'integrations.logs.view', name: 'View technical integration logs', module: 'integrations' },
  { code: 'integrations.diagnostics', name: 'Run integration diagnostics', module: 'integrations' },
  { code: 'integrations.payment.test', name: 'Test payment adapter', module: 'integrations' },
  { code: 'integrations.storage.test', name: 'Test object storage', module: 'integrations' },
  { code: 'integrations.messaging.test', name: 'Test messaging (email/SMS)', module: 'integrations' },
  { code: 'integrations.queue.retry', name: 'Retry / discard queue jobs', module: 'integrations' },
  { code: 'integrations.webhooks.view', name: 'View webhook events', module: 'integrations' },
];
...
export const ROLE_DEFS: RoleDef[] = [
  ...
  { name: 'HR Manager', description: 'HR, performance & payroll', permissions: ['hr.*', 'performance.*', 'payroll.*', 'recruitment.*', 'reports.view'] },
  { name: 'Payroll Officer', description: 'Process payroll', permissions: ['hr.employees.view', 'payroll.view', 'payroll.process', 'performance.incentives.view'] },
  { name: 'Performance QA Reviewer', description: 'Quality assurance reviews of performance assessments', permissions: [
    'performance.qa.view', 'performance.qa.review', 'performance.team.view', 'performance.self.view', 'performance.reports.view',
  ] },

...
export const PERMISSIONS: PermissionDef[] = [
  ...
  { code: 'recruitment.view', name: 'View recruitment', module: 'hr' },
  { code: 'recruitment.requisitions.create', name: 'Create requisitions', module: 'hr' },
  { code: 'recruitment.requisitions.approve', name: 'Approve requisitions', module: 'hr' },
  { code: 'recruitment.vacancies.create', name: 'Create vacancies', module: 'hr' },
  { code: 'recruitment.vacancies.publish', name: 'Publish vacancies', module: 'hr' },
  { code: 'recruitment.candidates.edit', name: 'Edit candidates', module: 'hr' },
  { code: 'recruitment.applications.manage', name: 'Manage applications', module: 'hr' },
  { code: 'recruitment.interviews.manage', name: 'Manage interviews', module: 'hr' },
  { code: 'recruitment.offers.create', name: 'Create offers', module: 'hr' },
  { code: 'recruitment.offers.approve', name: 'Approve offers', module: 'hr' },
  { code: 'recruitment.offers.send', name: 'Send offers', module: 'hr' },
  { code: 'recruitment.hire', name: 'Hire candidates', module: 'hr' },
  { code: 'hr.leave.view', name: 'View leave', module: 'hr' },
  { code: 'hr.leave.request', name: 'Request leave', module: 'hr' },
  { code: 'hr.leave.approve', name: 'Approve leave', module: 'hr' },
  { code: 'hr.leave.manage', name: 'Manage leave', module: 'hr' },
  { code: 'hr.attendance.view', name: 'View attendance', module: 'hr' },
  { code: 'hr.attendance.manage', name: 'Manage attendance', module: 'hr' },
  { code: 'hr.performance.view_self', name: 'View own performance', module: 'hr' },
  { code: 'hr.performance.view_team', name: 'View team performance', module: 'hr' },
  { code: 'hr.performance.manage', name: 'Manage performance', module: 'hr' },
  { code: 'hr.performance.calibrate', name: 'Calibrate performance', module: 'hr' },
  { code: 'payroll.view_compensation', name: 'View compensation', module: 'hr' },
  { code: 'payroll.create', name: 'Create payroll', module: 'hr' },
  { code: 'payroll.calculate', name: 'Calculate payroll', module: 'hr' },
  { code: 'payroll.review', name: 'Review payroll', module: 'hr' },
  { code: 'payroll.post', name: 'Post payroll', module: 'hr' },
  { code: 'payroll.pay', name: 'Pay payroll', module: 'hr' },
  { code: 'payroll.payslips.publish', name: 'Publish payslips', module: 'hr' },
  ...
  { code: 'fiscalisation.submit', name: 'Fiscalise documents', module: 'fiscalisation' },
  { code: 'fiscalisation.retry', name: 'Retry fiscalisation', module: 'fiscalisation' },
  { code: 'fiscalisation.days.view', name: 'View fiscal days', module: 'fiscalisation' },
  { code: 'fiscalisation.days.open', name: 'Open fiscal days', module: 'fiscalisation' },
  { code: 'fiscalisation.days.close', name: 'Close fiscal days', module: 'fiscalisation' },
  { code: 'fiscalisation.receipts.view', name: 'View fiscal receipts', module: 'fiscalisation' },
  { code: 'fiscalisation.reports.view', name: 'View fiscal reports', module: 'fiscalisation' },
  { code: 'fiscalisation.reports.export', name: 'Export fiscal reports', module: 'fiscalisation' },
  { code: 'fiscalisation.devices.manage', name: 'Manage fiscal devices', module: 'fiscalisation' },
  { code: 'fiscalisation.configuration.manage', name: 'Manage fiscal configuration', module: 'fiscalisation' },
...
export const ROLE_DEFS: RoleDef[] = [
  ...
  { name: 'HR Manager', description: 'HR & payroll', permissions: ['hr.*', 'payroll.*', 'recruitment.*', 'reports.view'] },

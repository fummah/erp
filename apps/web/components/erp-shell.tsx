    ...
    key: 'grp-ops', label: 'Operations', children: [
      {
        key: '/finance', label: 'Finance & Accounting', icon: <DollarOutlined />, color: '#003366', children: [
          ...
          { key: '/finance/cashflow', label: 'Cash Flow' },
...
const PAGE_TITLES: Record<string, [string, string]> = {
  ...
  '/finance/profit-loss': ['Profit & Loss', 'Revenue and expenses over a period'],
  '/finance/balance-sheet': ['Balance Sheet', 'Assets, liabilities and equity'],
  '/finance/cashflow': ['Cash Flow', 'Cash inflows and outflows over time'],
...
const PAGE_ICONS: Record<string, React.ReactNode> = {
  ...
  '/finance/ledger': <BarsOutlined />, '/finance/trial-balance': <SolutionOutlined />,   '/finance/reports': <BarChartOutlined />, '/finance/profit-loss': <BarChartOutlined />, '/finance/balance-sheet': <SolutionOutlined />, '/finance/cashflow': <WalletOutlined />, '/finance/ar-aging': <TeamOutlined />, '/finance/ap-aging': <ShopOutlined />, '/finance/costing': <AppstoreOutlined />, '/projects': <AppstoreOutlined />, '/hr': <TeamOutlined />, '/hr/payroll-rules': <PercentageOutlined />, '/hr/recruitment': <UserOutlined />, '/hr/onboarding': <SolutionOutlined />, '/hr/leave-benefits': <CalendarOutlined />,
